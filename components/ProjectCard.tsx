...
const ProjectCard: React.FC<ProjectCardProps> = ({ project }) => {
  return (
    <div className="group relative overflow-hidden rounded-lg shadow-lg bg-gray-800/50 backdrop-blur-sm transition-all duration-500 ease-in-out transform hover:scale-105 hover:shadow-purple-500/30 border border-purple-500/20">
